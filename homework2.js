...
function searchCountry(name){
    let found = getCountries(countries).find(item => item.name === name);
    return found;
}

//console.log(searchCountry("Georgia"));

// დავალება 3
function sortCountries(data) {
    // იმპლემენტაცია
    let sorting = getCountries(countries).sort(function (a,b) {return  a-b});
    return sorting;
